...
class analyze:
    def __init__(self):
        self.date_of_game = '2023/08/06'
        self.name_of_category = '第71回NHK杯2回戦'
        self.black_player = '小池芳弘七段'
        self.white_player = '本木克弥八段'
    ...
    def analyze_policy(self, record, bo):
        ...
        fp = open('analize_result_policy.txt', 'w', 1, 'UTF-8')
        ...
        for ply in range(1, len(record.moves) + 1):
            ...
            li = []
            fe = ft.make_input_features(bo, record, ply - 2)
            li.append(fe)
