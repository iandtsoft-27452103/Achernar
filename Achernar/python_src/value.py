...
class value(nn.Module):
    def __init__(self):
        ...
        self.batch_size = 0
        self.l1 = nn.Conv2d(in_channels = 44, out_channels = ch, kernel_size = 5, padding = 2, bias = False)
        ...
        #self.b14 = block()
        #self.b15 = block()
        self.l2 = nn.Conv2d(ch, 1, 1, 1, 0, 1, 1, True)
        self.n2 = nn.BatchNorm2d(1, eps = 2e-05)
